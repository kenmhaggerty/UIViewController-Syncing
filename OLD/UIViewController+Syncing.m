...
- (UIView *)viewForSyncView
{
    ...
    if (!viewForSyncView)
    {
        ...
        [AKDebugger logMethod:METHOD_NAME logType:AKLogTypeDebug methodType:AKMethodTypeGetter customCategories:@[AKD_UI] message:[NSString stringWithFormat:@"frame = (%f, %f, %f, %f)", viewForSyncView.frame.origin.x, viewForSyncView.frame.origin.y, viewForSyncView.frame.size.width, viewForSyncView.frame.size.height]];
